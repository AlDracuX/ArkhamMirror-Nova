      ...
      {Object.keys(templates).length > 0 && (
        <div style={{
          ...
          <span style={{ fontSize: '13px', color: '#1e40af' }}>
            {Object.keys(templates).length} claim type templates available with pre-defined legal elements
          </span>
        </div>
      )}

      {loading ? (
        <div style={{ textAlign: 'center', padding: '48px', color: '#6b7280' }}>Loading theories...</div>
      ) : theories.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '48px', color: '#6b7280' }}>
          ...
          <p style={{ fontSize: '13px', marginTop: '8px' }}>
            Available templates: {Object.keys(CLAIM_TYPE_LABELS).filter(k => k !== 'custom').join(', ')}
          </p>
        </div>
      ) : (
          ...
          {theories.map(t => (
            ...
            >
              ...
              <div style={{ marginTop: '12px' }}>
                ...
                <div style={{
                  height: '6px', borderRadius: '3px', background: '#f3f4f6', overflow: 'hidden',
                }}>
                  <div style={{
                    height: '100%', width: `${t.overall_strength}%`, borderRadius: '3px',
