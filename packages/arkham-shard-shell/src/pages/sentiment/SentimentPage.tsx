...
import type { SentimentAnalysis, SentimentPattern, ComparatorDiff } from './types';
import { TONE_CATEGORY_OPTIONS, PATTERN_TYPE_OPTIONS, SENTIMENT_DIRECTION_OPTIONS } from './types';
...
function AnalysesTab() {
    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '13px' }}>
          ...
          <br />
          tone shifts, hostility patterns, and discriminatory language.
        </p>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      {items.map((item) => {
        const sentiment =
          typeof item.overall_sentiment === 'number'
        ...
        return (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              {/* Sentiment gauge */}
              {sentiment != null && <SentimentGauge value={sentiment} size={40} />}
              ...
              {sentimentConf && (
                <span
                  style={{
                    ...
                    fontSize: '11px',
                    fontWeight: 700,
                    background: `${sentimentConf.color}12`,
                    color: sentimentConf.color,
                  }}
                >
                  {sentimentConf.label}
                </span>
    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '13px' }}>
          ...
          <br />
          Use the project selector in the top bar to choose a project.
        </p>
    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '13px' }}>
          ...
          <br />
          hostility escalation, gaslighting, and tone shift patterns.
        </p>
      </div>
    );
  }
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: 'right', minWidth: '80px' }}>
                ...
                <div
                  style={{ fontSize: '22px', fontWeight: 700, color: getSignificanceColor(sigPct) }}
                >
                  {sigPct}%
                </div>
              </div>
    ...
    return (
      ...
      >
        ...
        <p style={{ marginTop: '12px', fontWeight: 500 }}>
          {!projectId
            ? 'Select a project to view comparator divergence'
            : 'No comparator divergence found'}
        </p>
        <p style={{ fontSize: '13px' }}>
          Compare tone and language used toward the claimant vs. comparators.
          <br />
          Divergent treatment in language supports s.13 and s.26 arguments.
        </p>
      </div>
    );
  }
          ...
          >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                {diff.findings.length > 0 && (
                  ...
                  >
                    ...
                    <ul
                      style={{ margin: 0, paddingLeft: '16px', fontSize: '13px', lineHeight: 1.7 }}
                    >
              ...
              <div style={{ textAlign: 'right', minWidth: '100px' }}>
                ...
                <div style={{ fontSize: '28px', fontWeight: 700, color: divColor }}>{divPct}%</div>
        ...
        {analysis.document_id && (
          <div>
            ...
            <div style={{ fontFamily: 'monospace', marginTop: '2px' }}>
              {analysis.document_id.slice(0, 12)}...
            </div>
          </div>
        )}
        {analysis.thread_id && (
...
function ToneMiniBar({ label, score, color }: { label: string; score: number; color: string }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
      <span
        style={{ fontSize: '10px', color: 'var(--arkham-text-muted, #9ca3af)', minWidth: '60px' }}
      >
        {label}
      </span>
      <div
        style={{
          ...
          height: '4px',
          borderRadius: '2px',
          background: 'var(--arkham-bg-tertiary, #e5e7eb)',
          overflow: 'hidden',
        }}
      >
    ...
    <div>
      ...
      <div
        style={{
          ...
          position: 'relative',
          background:
            'linear-gradient(to right, #dc2626, #ea580c, #d97706, #6b7280, #2563eb, #059669, #16a34a)',
          overflow: 'visible',
        }}
      >
        <div
