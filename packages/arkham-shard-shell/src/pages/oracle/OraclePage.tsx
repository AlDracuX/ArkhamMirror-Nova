    ...
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      <header style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          <div style={{
            width: '40px', height: '40px', borderRadius: '8px', background: '#f3f4f6',
      ...
      <div style={{ display: 'flex', gap: '4px', borderBottom: '1px solid #e5e7eb', marginBottom: '24px' }}>
        <button
          ...
          style={{
            ...
            fontSize: '14px', fontWeight: activeTab === 'sessions' ? 600 : 500,
        ...
        <button
          ...
          style={{
            padding: '12px 20px', border: 'none', background: 'transparent', cursor: 'pointer',
            fontSize: '14px', fontWeight: activeTab === 'authorities' ? 600 : 500,
            color: activeTab === 'authorities' ? '#2563eb' : '#6b7280',
            borderBottom: activeTab === 'authorities' ? '2px solid #2563eb' : '2px solid transparent',
            display: 'flex', alignItems: 'center', gap: '8px', transition: 'all 0.2s'
          }}
        >
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div>
        ...
        {items.length === 0 ? (
          <div style={{
            padding: '48px', textAlign: 'center', border: '2px dashed #e5e7eb', borderRadius: '12px',
            color: '#9ca3af'
          }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px' }}>
            {items.map((item) => (
              <div
                ...
                style={{
                  padding: '16px', borderRadius: '10px', background: '#fff',
...
function ResearchLauncher({ onStarted }: { onStarted: (id: string) => void }) {
  ...
  return (
    <div style={{
      ...
      border: '1px solid #e5e7eb', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)'
    }}>
      <h3 style={{ margin: '0 0 12px 0', fontSize: '16px', fontWeight: 600 }}>New Legal Research</h3>
      <div style={{ position: 'relative' }}>
        <textarea
          ...
          style={{
            ...
            border: '1px solid #d1d5db', fontSize: '14px', lineHeight: '1.5',
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '12px' }}>
          ...
          <button
            ...
            style={{
              padding: '10px 20px', borderRadius: '6px', background: '#2563eb',
              color: 'white', border: 'none', cursor: 'pointer', fontWeight: 600,
              fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px',
              opacity: busy ? 0.7 : 1, transition: 'background 0.2s'
            }}
          >
            {busy ? <Icon name="Loader2" size={16} className="animate-spin" /> : <Icon name="Zap" size={16} />}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <div style={{ fontSize: '12px', color: '#6b7280', display: 'flex', alignItems: 'center', gap: '4px' }}>
             <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#7c3aed' }} /> Supreme
          </div>
          <div style={{ fontSize: '12px', color: '#6b7280', display: 'flex', alignItems: 'center', gap: '4px' }}>
             <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#2563eb' }} /> CoA
          </div>
          <div style={{ fontSize: '12px', color: '#6b7280', display: 'flex', alignItems: 'center', gap: '4px' }}>
             <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#059669' }} /> EAT
          </div>
        </div>
      </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: 'white', cursor: 'pointer', borderLeft: `4px solid ${courtConfig}`
                }}
              >
                <div style={{ flex: 1 }}>
                ...
                <div style={{ textAlign: 'right', display: 'flex', alignItems: 'center', gap: '16px' }}>
                  <div style={{
                    ...
                    background: courtConfig, color: 'white'
                  }}>
                    {court}
                  </div>
                  <Icon name="ChevronRight" size={18} color="#d1d5db" />
    ...
    (async () => {
      try {
        ...
        if (!!meta.authority_ids && meta.authority_ids.length > 0) {
          const authPromises = meta.authority_ids.slice(0, 10).map(id => api.getAuthority(id).catch(() => null));
    ...
    <div style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto' }}>
      <button
        ...
        style={{
          ...
          color: '#2563eb', cursor: 'pointer', fontSize: '14px', fontWeight: 600, padding: 0,
          marginBottom: '24px'
        }}
      >
      ...
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e5e7eb', padding: '24px', marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#6b7280', fontSize: '13px', marginBottom: '12px' }}>
          <Icon name="Clock" size={14} /> Investigation started {new Date(String(item.created_at)).toLocaleString()}
        </div>
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          <div style={{ padding: '12px 20px', background: '#f0f9ff', borderRadius: '8px', border: '1px solid #bae6fd' }}>
            <div style={{ fontSize: '12px', color: '#0369a1', fontWeight: 700, textTransform: 'uppercase', marginBottom: '4px' }}>
              Authorities Found
            </div>
      ...
      <h2 style={{ fontSize: '18px', fontWeight: 600, marginBottom: '16px' }}>Relevant Authorities</h2>
          ...
          {authorities.map((auth, idx) => {
            ...
            return (
              <div
                ...
                onClick={() => onSelectAuthority(String(auth.id))}
                style={{
                  padding: '16px', borderRadius: '10px', background: 'white', border: '1px solid #e5e7eb',
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '12px', color: '#9ca3af' }}>
                  ...
                  {!!aMeta.binding_type && (
                    <span style={{
                      padding: '1px 6px', borderRadius: '4px', background: '#f3f4f6',
    ...
    <div style={{ padding: '24px', maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div style={{ background: 'white', borderRadius: '16px', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '32px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
              <div>
                <h1 style={{ fontSize: '28px', fontWeight: 800, margin: '0 0 8px 0', fontStyle: 'italic', color: '#111827' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', alignItems: 'flex-end' }}>
                <div style={{
                  padding: '6px 16px', borderRadius: '6px', background: courtColor,
                  color: 'white', fontWeight: 800, fontSize: '13px'
                }}>
                  {court}
                </div>
                <div style={{
                  padding: '4px 12px', borderRadius: '20px', border: `1px solid ${isBinding ? '#dc2626' : '#d1d5db'}`,
                  color: isBinding ? '#dc2626' : '#6b7280', fontWeight: 700, fontSize: '11px',
                  textTransform: 'uppercase', background: isBinding ? '#fef2f2' : 'transparent'
                }}>
                  {String(meta.binding_type || 'persuasive')}
                </div>
              </div>
            ...
            <section style={{ marginBottom: '32px' }}>
              <h3 style={{
                fontSize: '12px', fontWeight: 800, color: '#374151', textTransform: 'uppercase',
              ...
              <div style={{
                padding: '20px', background: '#f8fafc', borderRadius: '12px', borderLeft: `4px solid ${courtColor}`,
                fontSize: '16px', lineHeight: '1.6', color: '#1e293b', fontWeight: 500
              }}>
                {String(meta.ratio_decidendi || 'The ratio for this authority has not been extracted yet.')}
              </div>
            </section>
            ...
            <section>
              ...
              <div style={{ fontSize: '15px', lineHeight: '1.7', color: '#4b5563', whiteSpace: 'pre-wrap' }}>
                {String(meta.case_summary || item.description || 'Detailed case summary is currently unavailable.')}
              </div>
            </section>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
          <button style={{
            padding: '10px 16px', borderRadius: '6px', background: 'white', border: '1px solid #d1d5db',
          ...
          <button style={{
            padding: '10px 16px', borderRadius: '6px', background: '#2563eb', border: 'none',
