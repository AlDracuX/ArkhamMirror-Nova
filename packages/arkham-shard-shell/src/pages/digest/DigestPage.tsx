...
export function DigestPage() {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      {activeTab === 'briefings' && (
        <BriefingsTab projectId={projectId ? String(projectId) : null} />
      )}
      {activeTab === 'changelog' && (
        <ChangelogTab projectId={projectId ? String(projectId) : null} />
      )}
    </div>
  );
}
    ...
    return (
      ...
      >
        ...
        <p style={{ fontSize: '14px' }}>
          Generate your first daily or weekly briefing to see case summaries here.
        </p>
      </div>
    );
  }
      ...
      {briefings.map((brief) => (
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            >
              {String(
                brief.description || brief.summary || 'Click to view full case summary...'
              ).slice(0, 160)}
  ...
  if (changes.length === 0) {
    return (
      ...
      >
        ...
        <p style={{ fontSize: '14px' }}>
          Cross-shard activities will appear here as you work on this project.
        </p>
      </div>
    );
  }
        ...
        >
          ...
          <div
            style={{
              width: '4px',
              height: '24px',
              background: getShardColor(String(change.shard || '')),
              borderRadius: '2px',
            }}
          />
    ...
    <div style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '40px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
          ...
          >
            Generated on {formatDate(String(briefing.created_at || ''))} at{' '}
            {formatTime(String(briefing.created_at || ''))}
          </span>
        </div>
        ...
        >
          {String(
            briefing.description ||
              briefing.summary ||
              'Consolidated case summary and action items.'
          )}
        </p>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          >
            ...
            {actionItems.length === 0 ? (
              <p
                style={{ color: 'var(--arkham-text-muted)', fontSize: '15px', fontStyle: 'italic' }}
              >
