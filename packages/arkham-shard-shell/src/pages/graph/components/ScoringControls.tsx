  ...
  return (
    <div className="control-section">
      ...
      <div className="control-group">
        ...
        <span className="control-hint">Combine multiple signals for node importance</span>
      </div>
      ...
      {settings.enabled && (
        <>
          {/* Recalculate Button */}
          <div className="control-group">
            <button className="recalculate-btn" onClick={onRecalculate} disabled={isLoading}>
              {isLoading ? (
                <>
        ...
        <>
          ...
          <div className="control-group">
            ...
            <select
              ...
              onChange={(e) =>
                onChange({ centralityType: e.target.value as ScoringSettings['centralityType'] })
              }
                ...
                return (
                  <div key={key} className="weight-row">
                    <div className="weight-header">
                      ...
                      <span className="weight-value">{(normalizedValue * 100).toFixed(0)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0"
          ...
          <div className="control-group">
            ...
            <span className="control-hint">How quickly old mentions lose weight</span>
          </div>
        </>
      )}
    </div>
